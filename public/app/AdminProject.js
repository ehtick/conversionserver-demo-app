class AdminProject {
    ...
    async refreshProjectTable() {
        ...
        var response = await fetch(serveraddress + '/api/projectusers/' + this.editProject.id);
    ...
    async _acceptEdit(event) {
        ...
        let response = await fetch(serveraddress + '/api/projectusers/' + this.editProject.id);
        ...
        if (!isUser) {
            let res = await fetch(serveraddress + '/api/addProjectUser/' + this.editProject.id + "/" + email + "/" + role, { method: 'PUT' });
        }
        else
        {
            let res = await fetch(serveraddress + '/api/updateProjectUser/' + this.editProject.id + "/" + email + "/" + role, { method: 'PUT' });
        }
    ...
    async handleEditProjectDialog() {
        ...
        var response = await fetch(serveraddress + '/api/hubusers/' + myAdmin.currentHub.id);
